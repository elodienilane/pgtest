...
(function (v, q, f, r) {
    ...
    f.extend(b, {
        ...
        open: function (a, d) {
            ...
            if (a && (f.isPlainObject(d) || (d = {}), !1 !== b.close(!0))) return f.isArray(a) || (a = y(a) ? f(a).get() : [a]), f.each(a, function (e, c) {
        ...
        reposition: function (a, d) {
            ...
            b.isOpen && (e = b._getPosition(d), a && "scroll" === a.type ? (delete e.position, b.wrap.stop(!0, !0).animate(e,
        ...
        bindEvents: function () {
            ...
            a && (p.bind("orientationchange.fb" + (a.autoResize ? " resize.fb" : "") + (a.autoCenter && !a.locked ? " scroll.fb" : ""), b.update), (d = a.keys) && n.bind("keydown.fb", function (e) {
                ...
                !e.ctrlKey && (!e.altKey && !e.shiftKey && !e.metaKey && (!j || !j.type && !f(j).is("[contenteditable]"))) && f.each(d, function (d, j) {
                    ...
                    if (1 < a.group.length && j[c] !== r) return b[d](j[c]), e.preventDefault(), !1;
        ...
        _setDimension: function () {
            ...
            if ("iframe" === h.type) {
                ...
                if (F = h.content, h.autoHeight && 1 === F.data("ready")) try {

                    F[0].contentWindow.document.location && (g.width(B).height(9999), E = F.contents().find("body"),

                    r && E.css("overflow-x", "hidden"), z = E.height())

                } catch (G) {}

            } else if (h.autoWidth || h.autoHeight) g.addClass("fancybox-tmp"), h.autoWidth || g.width(B), h.autoHeight || g.height(z), h.autoWidth && (B = g.width()), h.autoHeight && (z = g.height()), g.removeClass("fancybox-tmp");
            ...
            h.aspectRatio ? (c > m && (c = m, i = c / C), i > n && (i = n, c = i * C), c < l && (c = l, i = c / C), i < u && (i = u, c = i * C)) : (c = Math.max(l, Math.min(c, m)),

            i = Math.max(u, Math.min(i, n)));

            if (h.fitToView) if (m = Math.min(a.w - s, m), n = Math.min(a.h - v, n), g.width(k(c)).height(k(i)), e.width(k(c + x)), a = e.width(), s = e.height(), h.aspectRatio) for (;

            (a > p || s > q) && (c > l && i > u) && !(19 < d++);) i = Math.max(u, Math.min(n, i - 10)), c = i * C, c < l && (c = l, i = c / C), c > m && (c = m, i = c / C), g.width(k(c)).height(k(i)), e.width(k(c + x)), a = e.width(), s = e.height();

            else c = Math.max(l, Math.min(c, c - (a - p))), i = Math.max(u, Math.min(i, i - (s - q)));
        ...
        _afterZoomIn: function () {
            ...
            a && (b.isOpen = b.isOpened = !0, b.wrap.addClass("fancybox-opened").css("overflow", "ee"), b.reposition(), (a.closeClick || a.nextClick) && b.inner.css("cursor", "pointer").bind("click.fb", function (d) {
